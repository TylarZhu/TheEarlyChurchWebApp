...
namespace Domain.Common
{
    ...
    {
        private readonly ConcurrentDictionary<string, List<string>> _explanation = new ConcurrentDictionary<string, List<string>>();
        public Explanation()
        {
            _explanation.TryAdd("Nicodemus", new List<string> { 
            ...
            _explanation.TryAdd("Peter", new List<string> {
            ...
            _explanation.TryAdd("John", new List<string> {
                "The important leader of Christians.",
            ...
            _explanation.TryAdd("Laity", new List<string> {
                "Ordinary believers, do not have any abilities.",
                "Find the Judaisms and remove their vote weights."
            });
            _explanation.TryAdd("Judas", new List<string> {
                "He knows who is the Priest",
            ...
            _explanation.TryAdd("Scribes", new List<string> {
            ...
            _explanation.TryAdd("Pharisee", new List<string>
            {
                "He have the chance to become the Priest",
                "If he did not becomes the Prist, he will be the Ruler of The Synagogue.",
                "If he is the Priest, he has the ability to try to exiled one person every night.",
            ...
            _explanation.TryAdd("Judaism", new List<string>
            {
                "Ordinary believers, do not have any abilities.",
        ...
        public List<string>? getExplanation(string identity)
        {
